...
/*        $query = "SELECT * FROM posts WHERE post_id = $comment_post_id ";
    ...
    echo "<td class='text-center'><a class='btn btn-default' href='users.php?change_to_sub={$user_id}'>Subscriber</a></td>";   
    echo "<td class='text-center'><a class='btn btn-warning' href='users.php?source=edit_user&edit_user={$user_id}'>Edit</a></td>";
